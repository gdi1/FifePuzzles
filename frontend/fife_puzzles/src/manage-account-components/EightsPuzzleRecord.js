...
export default function EightsPuzzleRecord({ isActive, rating, puzzle, id, difficulty, handleButtonPress = () => { }, handleLoadComments, forCreated = true, date }) {
    return (
        <CardContainer>
            <InfoPart>
            ...
            <PuzzlePart>
                <MiniEightsPuzzle puzzle={puzzle} />
            </PuzzlePart>
            <Buttons>
                {forCreated &&
                    <>
