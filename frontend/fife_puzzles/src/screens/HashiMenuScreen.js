...
export default function HashiMenuScreen() {
      ...
      (async () => {
        ...
        try{
          ...
          let upload_result = await fetch(
            `${process.env.REACT_APP_BACKEND_URL}hashi/add_hashi_from_upload/`,
            {
              method: "POST",
              headers: {
              ...
              <GeneralButton
                ...
                handleButtonPress={async () => {
                  ...
                  let result = await fetch(
                    `${process.env.REACT_APP_BACKEND_URL}hashi/get_hashi_puzzle/`,
                    {
                      method: "POST",
                      headers: {
                        "Content-Type": "application/json",
